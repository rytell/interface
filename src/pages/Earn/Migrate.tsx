        ...
        <>
          <StepCard>
            <CardSection>
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>Step 1. Unstake Rytell liquidity (RYTL)</TYPE.white>
                </RowBetween>
                {requiresUnstake && (
                  <>
                    <RowBetween style={{ marginBottom: '1rem' }}>
                      <TYPE.white fontSize={14}>
                        {`You are currently staking deprecated RYTL tokens. Unstake to continue the migration process`}
                      </TYPE.white>
                    </RowBetween>
                    <ButtonPrimary
                      padding="8px"
          ...
          <StepCard>
            <CardSection>
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>Step 2. Convert Rytell liquidity tokens (RYTL)</TYPE.white>
                </RowBetween>
                {requiresConvert && (
                  <>
                    <RowBetween style={{ marginBottom: '1rem' }}>
                      <TYPE.white fontSize={14}>
                        {`You are currently holding deprecated RYTL tokens. Migrate them including the underlying assets they represent to continue the migration process`}
                      </TYPE.white>
                    </RowBetween>
                    {canZap ? (
                      <ButtonPrimary
                      ...
                      <ErrorText severity={2}>
                        {`Rytell does not support auto migration of this pair. Please withdraw the RYTL and upgrade the tokens at `}
          ...
          <StepCard>
            <CardSection>
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>Step 3. Stake Rytell liquidity (RYTL)</TYPE.white>
                </RowBetween>
                {requiresStake && (
                  <>
                    <ButtonPrimary
