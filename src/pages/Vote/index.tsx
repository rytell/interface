...
import { JSBI, TokenAmount, ChainId } from '@rytell/sdk'
...
export default function Vote() {
  ...
  const radiBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? RADI[chainId] : undefined)
