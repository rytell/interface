import { JSBI, Token, TokenAmount } from '@rytell/sdk'
...
export function computeRadiCirculation(radi: Token, blockTimestamp: BigNumber): TokenAmount {
  ...
  return new TokenAmount(radi, JSBI.multiply(wholeAmount, JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))))
}
